...
\\node[op amp, yscale=-1](N1) at (3,3) {}
  node[anchor=center] at (N1.text) {$U_1$};

\\draw
  (1,1) to[american resistor, l={$R_1$}] (3,1)
  (3,1) to[american resistor, l={$R_2$}] (5,1)
  (1,-0.5) to[capacitor, l={$C_1$}] (3,-0.5)
  (3,-0.5) to[capacitor, l={$C_2$}] (5,-0.5)
  (3,-0.5) -- (3,1)
  (5,-0.5) |- (N1.out)
  (1,-1) |- (N1.-)
  (1,-1) to[american resistor, l={$R_0$}] (1,-3)
  (5,3) -- (5.5,3)
  (1,3.5) |- (N1.+)
  (3,1) node[circ] {}
  (1,1) node[circ] {}
...
\\node[ocirc](N2) at (1,3.5) {}
  node[anchor=east] at (N2.text) {$v_i$};

\\node[ocirc](N3) at (5.5,3) {}
  node[anchor=west] at (N3.text) {$v_o$};
